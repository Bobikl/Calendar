...
//        return this.solar2lunar(2021, 5, 13)
//    },
    getLunartoDay: function(yy, mm, dd) {
//        var today = this.parseDate();
        var today = this.solar2lunar(yy, mm, dd)
        return today.gzYear + today.Animal + "年 " + today.IMonthCn + today.IDayCn + " " + (today.Term ? today.Term : "");
    },
    getLunartoDayEvery: function(yy, mm, dd) {
        var today = this.solar2lunar(yy, mm, dd)
        return today.IMonthCn + today.IDayCn
    },
    getLunartoDayIDayCn: function(yy, mm, dd){
        var today = this.solar2lunar(yy, mm, dd)
        return today.IDayCn
    }
};
